...
//
//
//public class VeiculoListAdapter extends ArrayAdapter<Veiculo> {
//
//
//    private Activity context;
//    private List<Kilometragem> kilometragemList;  // lista para armazenar os artitas
//
//    public ArtistListAdapter(Activity context, List<Kilometragem> kilometragemList) {
//
//        super(context, R.layout.layout_veiculo_item, kilometragemList);
...
//        View listViewItem = inflater.inflate(R.layout.layout_veiculo_item, null, true);
//
...
//        Kilometragem kilometragem = kilometragemList.get(position);
//
//        // finalmente, colocamos os valores do objeto artista recuperado
//        // nas views que formam nosso item da lista
//        textViewName.setText(kilometragem.getArtistName());
//        textViewGenre.setText(kilometragem.getArtistGenre());
//        textViewIdade.setText(kilometragem.getArtistIdade());
//
